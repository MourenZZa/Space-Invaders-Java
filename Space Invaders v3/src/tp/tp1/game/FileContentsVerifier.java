...
public class FileContentsVerifier{
	...
	public boolean verifyLevelString(String levelString) {
		...
		appendToFoundInFileString(words[0]);
		if (words.length != 2 || !verifyLevel((words[1])))
			return false;
		return true;
	}
	...
	public static boolean verifyLevel(String level) {
		return level != null;
	}
